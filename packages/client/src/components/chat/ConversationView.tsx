...
export function ConversationView({
  ...
  useEffect(() => {
    if (!isStreaming) { streamHadContentRef.current = false; return; }
  ...
  const shouldRenderLiveStreamMessage = isStreaming && !delayedCharacterInfo && !regenerateMessageId && !isStreamWindingDown;
  const showTypingIndicator = isStreaming && !delayedCharacterInfo && !!regenerateMessageId && !streamBuffer && !thinkingBuffer && conversationMessageStyle !== "bubble";
