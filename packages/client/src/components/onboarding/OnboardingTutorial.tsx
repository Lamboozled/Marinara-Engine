...
const STEPS: TourStep[] = [
  ...
  },
  {
    target: "panel-agents",
    title: "Agents",
    body: "Agents add optional features without making the base app heavy. Open Download Agents here to browse and install trackers, writers, maps, Conversation calls, and chat games, then enable the ones you want for each chat. You can update or uninstall them from the same catalog.",
    side: "bottom",
    openPanel: "agents",
    sprite: { src: "/sprites/mari/Mari_point_up_left.png", flip: true },
  },
