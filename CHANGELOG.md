...
- Added an opt-in Anime presentation for Game Mode with coordinated **Anime Game Prompt**, **Anime Episode Director**, and storyboard-only **Anime Game Video** presets, plus a setup-time Keyframes per Turn target available as `{{gameStoryboardKeyframeCount}}`.
